...
{
    public List<SizeDimensions> sizeDimensions = new List<SizeDimensions>();
    public Transform floorPosition;
    public Transform elevatorScale;
    public GameObject liftChangeObject;
    ...
    public Vector3 SetForwardAxisPosition()
    {
        return new Vector3(0, 0, sizeDimensions[currentLiftSizeIndex].elevatorForwardPosition);
    }
    public void SetLiftSize(int _index)
    {
        currentLiftSizeIndex = _index;
        elevatorScale.localScale = new Vector3(1, sizeDimensions[currentLiftSizeIndex].elevatorScaleSize,1);
        elevatorScale.localPosition =  SetForwardAxisPosition();
      //  reflectionProbe.transform.localPosition = new Vector3(0, 0, sizeDimensions[currentLiftSizeIndex].reflectionProbePos);
    }
    public void SetPlayerPosition()
    {
        playerLiftController.OnLiftSizePositionChange(new Vector3(floorPosition.position.x, playerLiftController.transform.position.y, floorPosition.position.z));
        playerVRLiftController.OnLiftSizePositionChange(new Vector3(floorPosition.position.x, playerVRLiftController.transform.position.y, floorPosition.position.z));
    }
    ...
    void Start()
    {
        ...
        SetLiftSize(currentLiftSizeIndex);
    }
    ...
    {
        liftChangeObject.SetActive(true);
        transform.GetComponent<Animation>().clip = openAnim;
        transform.GetComponent<Animation>().Play();
    ...
    {
        liftChangeObject.SetActive(false);
        transform.GetComponent<Animation>().clip = closeAnim;
        transform.GetComponent<Animation>().Play();
